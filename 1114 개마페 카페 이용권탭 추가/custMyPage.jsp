		...
		$.ajax({
			...
			success : function(data) {
				...
				$.each(arr,function(idx, item) {
					...
					var img_std = $("<img src='images/std_img/upload/"+item.std_image+"' width=500px height=333px alt=''class='img-fluid rounded'>");
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light navbar-transparent bg-faded nav-sticky">
		...
		<div class="container">
			...
			<a class="navbar-brand" href="index.do"> <img class='logo logo-dark' src="images/logo.png" alt=""> <!--                    <img class='logo logo-light hidden-md-down' src="images/logo-light.png" alt=""> 아래 검은로고로 대체함-->
			...
			<div id="navbarNavDropdown" class="navbar-collapse collapse">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown"><a class="nav-link"
						 aria-haspopup="true" aria-expanded="false"
						href="SNSList.do"><font style="color: black;">SNS</font></a></li>
		...
		<div class="rounded bg-white" style="width:62%; margin-left: 20%;">
			...
			<br>
 			...
 			<div style="position: relative; top: 20px; left: 20px;">
				<img src="cust_img/${loginVo.cust_img }" width="120" alt="" class=" img-fluid rounded-circle" style="display: inline;">
